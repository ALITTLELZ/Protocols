import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/3e3c9d-protocols-adding-wistd-water/3e3c9d-protocols-Adding-WISTD-Water.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"detailed_action_json/3e3c9d-protocols-adding-wistd-water.json"
    output_data = {
