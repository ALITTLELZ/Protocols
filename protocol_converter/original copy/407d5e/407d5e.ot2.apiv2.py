import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/407d5e/407d5e.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"detailed_action_json/407d5e.json"
    output_data = {
