import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/6b51bd/6b51bd.ot2.apiv2.py"
...
resume.'.format(filledwells_count, round(vol_per_well / 1000)))
    ...
    filename = f"detailed_action_json/6b51bd.json"
    output_data = {
