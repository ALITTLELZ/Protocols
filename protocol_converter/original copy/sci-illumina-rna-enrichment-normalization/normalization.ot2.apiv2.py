import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/sci-illumina-rna-enrichment-normalization/normalization.ot2.apiv2.py"
...
#            protocol.comment("New Vol Height = "+str(round(RSBHeight,2)))
    ...
    filename = f"detailed_action_json/sci-illumina-rna-enrichment-normalization.json"
    output_data = {
