import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/bc-rnadvance-viral-feat/beckman_viral.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"detailed_action_json/bc-rnadvance-viral-feat.json"
    output_data = {
