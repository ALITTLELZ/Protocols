import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/sci-mag-bind-blood-tissue-kit/sci-mag-bind-blood-tissue-kit.ot2.apiv2.py"
...
#    tempdeck.set_temperature(4)
    ...
    filename = f"detailed_action_json/sci-mag-bind-blood-tissue-kit.json"
    output_data = {
