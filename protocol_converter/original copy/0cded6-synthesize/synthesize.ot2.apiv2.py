import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/0cded6-synthesize/synthesize.ot2.apiv2.py"
...
thermal cycler and run the COVIDSeq FSS program.\n\n\n\n')
    ...
    filename = f"detailed_action_json/0cded6-synthesize.json"
    output_data = {
