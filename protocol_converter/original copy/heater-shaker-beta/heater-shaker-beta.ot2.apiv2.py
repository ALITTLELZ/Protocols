import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/heater-shaker-beta/heater-shaker-beta.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"detailed_action_json/heater-shaker-beta.json"
    output_data = {
