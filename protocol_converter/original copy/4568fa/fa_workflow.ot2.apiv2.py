import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/4568fa/fa_workflow.ot2.apiv2.py"
...
these temperatures, and run protocol again once these temperatures are  reached.')
    ...
    filename = f"detailed_action_json/4568fa.json"
    output_data = {
