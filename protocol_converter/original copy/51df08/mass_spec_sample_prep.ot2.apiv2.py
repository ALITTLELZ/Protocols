import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/51df08/mass_spec_sample_prep.ot2.apiv2.py"
...
into OT-2')
    ...
    filename = f"detailed_action_json/51df08.json"
    output_data = {
