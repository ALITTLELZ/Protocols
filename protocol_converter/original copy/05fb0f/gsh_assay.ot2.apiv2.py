import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/05fb0f/gsh_assay.ot2.apiv2.py"
...
a new Slot 11) Eppendorf 96 DWP 1200ul and place Tecan 96 Well Plate 1200  ul back on the Slot 10) Heater Shaker')
    ...
    filename = f"detailed_action_json/05fb0f.json"
    output_data = {
