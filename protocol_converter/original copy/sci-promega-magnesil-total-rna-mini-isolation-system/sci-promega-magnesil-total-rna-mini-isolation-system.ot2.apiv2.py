import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/sci-promega-magnesil-total-rna-mini-isolation-system/sci-promega-magnesil-total-rna-mini-isolation-system.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"detailed_action_json/sci-promega-magnesil-total-rna-mini-isolation-system.json"
    output_data = {
