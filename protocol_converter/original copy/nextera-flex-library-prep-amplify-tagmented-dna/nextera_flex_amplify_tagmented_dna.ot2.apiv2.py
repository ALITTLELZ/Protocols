import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/nextera-flex-library-prep-amplify-tagmented-dna/nextera_flex_amplify_tagmented_dna.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"detailed_action_json/nextera-flex-library-prep-amplify-tagmented-dna.json"
    output_data = {
