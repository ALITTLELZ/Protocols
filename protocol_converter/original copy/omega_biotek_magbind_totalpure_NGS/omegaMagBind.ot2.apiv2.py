import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/omega_biotek_magbind_totalpure_NGS/omegaMagBind.ot2.apiv2.py"
...
def run(protocol_context):
    ...
    filename = f"detailed_action_json/omega_biotek_magbind_totalpure_NGS.json"
    output_data = {
