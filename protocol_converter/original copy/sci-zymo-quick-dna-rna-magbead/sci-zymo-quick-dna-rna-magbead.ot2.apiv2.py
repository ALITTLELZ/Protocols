import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/sci-zymo-quick-dna-rna-magbead/sci-zymo-quick-dna-rna-magbead.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"detailed_action_json/sci-zymo-quick-dna-rna-magbead.json"
    output_data = {
