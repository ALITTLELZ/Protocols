import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/5c7384-hhu/mass_spec_sample_prep_hhu.ot2.apiv2.py"
...
37C.')
    ...
    filename = f"detailed_action_json/5c7384-hhu.json"
    output_data = {
