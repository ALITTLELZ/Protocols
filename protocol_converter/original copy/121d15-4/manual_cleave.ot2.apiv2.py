import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/121d15-4/manual_cleave.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"detailed_action_json/121d15-4.json"
    output_data = {
