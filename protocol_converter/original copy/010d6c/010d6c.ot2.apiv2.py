import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/010d6c/010d6c.ot2.apiv2.py"
...
#                         new_tip='never')
    ...
    filename = f"detailed_action_json/010d6c.json"
    output_data = {
