import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/1c8468/1c8468.ot2.apiv2.py"
...
to the protocol website.''')
    ...
    filename = f"detailed_action_json/1c8468.json"
    output_data = {
