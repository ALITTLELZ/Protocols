import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/gna_octea_v2/gna_octea_v2.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"detailed_action_json/gna_octea_v2.json"
    output_data = {
