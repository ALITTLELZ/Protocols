import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/swift-fully-automated/swift-2s-turbo-fully-automated.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"detailed_action_json/swift-fully-automated.json"
    output_data = {
