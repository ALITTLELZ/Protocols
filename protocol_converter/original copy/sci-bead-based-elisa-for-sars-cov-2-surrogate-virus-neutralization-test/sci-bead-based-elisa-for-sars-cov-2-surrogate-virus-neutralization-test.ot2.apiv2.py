import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/sci-bead-based-elisa-for-sars-cov-2-surrogate-virus-neutralization-test/sci-bead-based-elisa-for-sars-cov-2-surrogate-virus-neutralization-test.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"detailed_action_json/sci-bead-based-elisa-for-sars-cov-2-surrogate-virus-neutralization-test.json"
    output_data = {
