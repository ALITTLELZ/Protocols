import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/4fa62e/4fa62e.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"detailed_action_json/4fa62e.json"
    output_data = {
