import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/macherey-nagel-nucleomag-size-select/macherey-nagel-nucleomag-size-select.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"detailed_action_json/macherey-nagel-nucleomag-size-select.json"
    output_data = {
