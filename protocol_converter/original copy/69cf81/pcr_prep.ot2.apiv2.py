import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/69cf81/pcr_prep.ot2.apiv2.py"
...
with {num_primers} primers.')
    ...
    filename = f"detailed_action_json/69cf81.json"
    output_data = {
