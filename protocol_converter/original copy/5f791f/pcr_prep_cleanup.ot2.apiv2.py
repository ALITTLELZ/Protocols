import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/5f791f/pcr_prep_cleanup.ot2.apiv2.py"
...
(slot 2) with clean plate for elution.')
    ...
    filename = f"detailed_action_json/5f791f.json"
    output_data = {
