import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/macherey-nagel-nucleomag-dna-food/macherey-nagel-nucleomag-dna-food.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"detailed_action_json/macherey-nagel-nucleomag-dna-food.json"
    output_data = {
