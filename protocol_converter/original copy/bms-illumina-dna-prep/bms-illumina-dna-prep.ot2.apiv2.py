import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/bms-illumina-dna-prep/bms-illumina-dna-prep.ot2.apiv2.py"
...
#        temp_block.set_temperature(4)
    ...
    filename = f"detailed_action_json/bms-illumina-dna-prep.json"
    output_data = {
