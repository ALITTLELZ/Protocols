import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/69486f/ngs_prep.ot2.apiv2.py"
...
CHANGE THE TUBERACK 1 (SLOT 7) ACCORDING TO REAGENT MAP 2')
    ...
    filename = f"detailed_action_json/69486f.json"
    output_data = {
