import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/121d15-7-2ml-2ml-pool/pooling.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"detailed_action_json/121d15-7-2ml-2ml-pool.json"
    output_data = {
