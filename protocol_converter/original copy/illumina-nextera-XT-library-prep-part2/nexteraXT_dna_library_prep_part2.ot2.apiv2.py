import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/illumina-nextera-XT-library-prep-part2/nexteraXT_dna_library_prep_part2.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"detailed_action_json/illumina-nextera-XT-library-prep-part2.json"
    output_data = {
