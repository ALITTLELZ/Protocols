import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/1af856/1af856.ot2.apiv2.py"
...
\n""".format(qpcr_mix))
    ...
    filename = f"detailed_action_json/1af856.json"
    output_data = {
