import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/swift-fully-automated-custom/swift-2s-turbo-fully-automated-custom.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"detailed_action_json/swift-fully-automated-custom.json"
    output_data = {
