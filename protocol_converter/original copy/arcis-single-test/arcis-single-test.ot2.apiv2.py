import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/arcis-single-test/arcis-single-test.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"detailed_action_json/arcis-single-test.json"
    output_data = {
