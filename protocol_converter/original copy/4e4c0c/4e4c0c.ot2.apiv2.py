import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/4e4c0c/4e4c0c.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"detailed_action_json/4e4c0c.json"
    output_data = {
