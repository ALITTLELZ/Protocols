import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/omega-biotek-xpress/omega-biotek-xpress.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"detailed_action_json/omega-biotek-xpress.json"
    output_data = {
