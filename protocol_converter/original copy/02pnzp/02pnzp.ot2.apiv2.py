import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/02pnzp/02pnzp.ot2.apiv2.py"
...
def run(prot):
    ...
    filename = f"detailed_action_json/02pnzp.json"
    output_data = {
