import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/zymo-ribofree-cleanup/cleanup.ot2.apiv2.py"
...
' + str(inc_temp) + ' minutes.')
    ...
    filename = f"detailed_action_json/zymo-ribofree-cleanup.json"
    output_data = {
