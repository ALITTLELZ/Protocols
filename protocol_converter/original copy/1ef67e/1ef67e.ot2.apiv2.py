import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/1ef67e/1ef67e.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"detailed_action_json/1ef67e.json"
    output_data = {
