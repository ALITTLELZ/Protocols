import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/0cded6-tagment/tagment.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"detailed_action_json/0cded6-tagment.json"
    output_data = {
