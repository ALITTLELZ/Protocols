import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/4a0be6/4a0be6.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"detailed_action_json/4a0be6.json"
    output_data = {
