import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/030dd8-cleanup/cleanup.ot2.apiv2.py"
...
# Replace on the magnetic stand.')
    ...
    filename = f"detailed_action_json/030dd8-cleanup.json"
    output_data = {
