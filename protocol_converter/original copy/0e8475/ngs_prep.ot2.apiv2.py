import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/0e8475/ngs_prep.ot2.apiv2.py"
...
{", ".join([rack.parent for rack in pip.tip_racks])}'
    ...
    filename = f"detailed_action_json/0e8475.json"
    output_data = {
