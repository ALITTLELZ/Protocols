import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/nextera-flex-library-prep-cleanup-libraries/nextera_flex_cleanup_libraries.ot2.apiv2.py"
...
days.')
    ...
    filename = f"detailed_action_json/nextera-flex-library-prep-cleanup-libraries.json"
    output_data = {
