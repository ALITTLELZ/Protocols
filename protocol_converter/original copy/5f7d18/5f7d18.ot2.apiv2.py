import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/5f7d18/5f7d18.ot2.apiv2.py"
...
of the Nest 15mL reservoir on Slot 11.\n''')
    ...
    filename = f"detailed_action_json/5f7d18.json"
    output_data = {
