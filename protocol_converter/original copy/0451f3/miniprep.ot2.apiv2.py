import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/0451f3/miniprep.ot2.apiv2.py"
...
magnetic module when complete.')
    ...
    filename = f"detailed_action_json/0451f3.json"
    output_data = {
