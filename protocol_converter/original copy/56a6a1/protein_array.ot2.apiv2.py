import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/56a6a1/protein_array.ot2.apiv2.py"
...
minutes. Scan the slides with GenePix 4400 A.')
    ...
    filename = f"detailed_action_json/56a6a1.json"
    output_data = {
