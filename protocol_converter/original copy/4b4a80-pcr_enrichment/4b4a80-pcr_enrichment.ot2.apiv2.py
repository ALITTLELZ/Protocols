import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/4b4a80-pcr_enrichment/4b4a80-pcr_enrichment.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"detailed_action_json/4b4a80-pcr_enrichment.json"
    output_data = {
