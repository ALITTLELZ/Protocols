import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/zymo-ribofree-first-strand-cdna-synth-universal-depletion/1_first_strand_synth_uni_depletion.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"detailed_action_json/zymo-ribofree-first-strand-cdna-synth-universal-depletion.json"
    output_data = {
