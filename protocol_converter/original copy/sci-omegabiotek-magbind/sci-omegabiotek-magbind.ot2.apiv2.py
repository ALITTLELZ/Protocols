import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/sci-omegabiotek-magbind/sci-omegabiotek-magbind.ot2.apiv2.py"
...
#        'nest_12_reservoir_15ml', '3', 'reagent reservoir 2')
    ...
    filename = f"detailed_action_json/sci-omegabiotek-magbind.json"
    output_data = {
