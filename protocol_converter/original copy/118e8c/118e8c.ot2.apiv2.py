import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/118e8c/118e8c.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"detailed_action_json/118e8c.json"
    output_data = {
