import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/zymo-quick-96/zymo-quick-96.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"detailed_action_json/zymo-quick-96.json"
    output_data = {
