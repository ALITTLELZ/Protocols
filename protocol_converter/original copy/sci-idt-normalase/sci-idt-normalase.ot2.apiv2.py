import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/sci-idt-normalase/sci-idt-normalase.ot2.apiv2.py"
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    filename = f"detailed_action_json/sci-idt-normalase.json"
    output_data = {
