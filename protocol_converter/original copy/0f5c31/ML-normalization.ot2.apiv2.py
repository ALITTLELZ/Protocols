import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/0f5c31/ML-normalization.ot2.apiv2.py"
...
#             ctx.pause('\n\n\n\nRemove filter plate (slot 5) and spin the  # H lysis into wells filter plate.\n\n\n\n')
    ...
    filename = f"detailed_action_json/0f5c31.json"
    output_data = {
