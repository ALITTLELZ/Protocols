import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/zymo-rna-extraction/zymo-rna-extraction.ot2.apiv2.py"
...
def run(protocol):
    ...
    filename = f"detailed_action_json/zymo-rna-extraction.json"
    output_data = {
