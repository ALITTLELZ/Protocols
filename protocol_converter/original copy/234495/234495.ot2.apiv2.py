import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/234495/234495.ot2.apiv2.py"
...
def run(ctx):
    ...
    **locations relative to top and center coded accordingly**
    ...
    filename = f"detailed_action_json/234495.json"
    output_data = {
