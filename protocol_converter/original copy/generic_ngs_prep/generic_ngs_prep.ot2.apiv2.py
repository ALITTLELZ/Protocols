import builtins
builtins.event_logs = []
__protocol_file__ = r"/Users/guangxinzhang/Documents/Deep_Potential/published_protocol/Protocols/protocol_converter/original copy/generic_ngs_prep/generic_ngs_prep.ot2.apiv2.py"
...
def run(ctx):
    ...
    filename = f"detailed_action_json/generic_ngs_prep.json"
    output_data = {
